...
export const projects: Project[] = [
  ...
  {
    slug: "basse-continue",
    title: "Basse continue",
    client: "Label Tempête",
    year: "2025",
    category: "son",
    poster: POSTER("marges-basse"),
    audio: SONG(1),
    audioTitle: "Basse continue — extrait",
    peaks: peaks["basse-continue"],
    runtime: "03:48",
    gear: "Neumann U87 · Pro Tools HDX",
    credits: [
      { memberSlug: "idriss-benali", roleId: "ingeson" },
      { memberSlug: "salome-vidal", roleId: "compositeur" },
    ],
    description:
      "Captation studio d'un album. Quatre micros, une pièce, aucune retouche — la dynamique brute laissée dans ses marges.",
    featured: true,
    order: 2,
  },
  {
